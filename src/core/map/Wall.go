...
func (b *Wall) Draw() {
	...
	rl.DrawRectangle(x, y, w, h, b.Color)
}

func (b *Wall) GetZIndex() int {
	return b.ZIndex
}

func (b *Wall) GetPosition() _type.Vector2 {
	return b.Position
}

func (b *Wall) GetCanCollide() bool {
	return b.CanCollide
}

func NewWall(pos _type.Vector2) objects.ObjectInterface {
	var x, y = pos.Get()
	return &Wall{
